...
public class svm {
	...
	public static svm_model svm_load_model_bytes(byte[] byte_array) throws IOException {
		return svm_load_model(new BufferedReader(new InputStreamReader(new ByteArrayInputStream(byte_array))));
	}
