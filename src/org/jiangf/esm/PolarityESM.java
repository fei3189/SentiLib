 ...
 *
 */
public class PolarityESM  extends ESM {
	public EmoticonSpaceFeatures esm;
	public SVMTool model;
	
	// text1, text should be segmented
	public PolarityESM(EmoticonSpaceFeatures c) throws IOException {
		esm = c;
		model = new SVMTool();
	}
	
	public PolarityESM(EmoticonSpaceFeatures c, SVMTool m) throws IOException {
		esm = c;
		model = m;
	}
...
/*	public void train(ArrayList<Entry<String, Integer>> dataSet, double C) {
		...
		model.train(features, labelList, 10, 0.005);
	}
