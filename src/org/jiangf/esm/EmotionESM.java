 ...
 *
 */
public class EmotionESM extends ESM {
	public EmoticonSpaceFeatures esm;
	public SVMTool model;
	
	// text1, text should be segmented
	public EmotionESM(EmoticonSpaceFeatures c) throws IOException {
		esm = c;
		model = new SVMTool();
	}
	
	public EmotionESM(EmoticonSpaceFeatures c, SVMTool m) throws IOException {
		esm = c;
		model = m;
	}
	...
	public void train(ArrayList<Entry<String, Integer>> dataSet, double C) {
		...
		model.train(features, labelList, C);
	}
